...
class AMapFlutterLocation {
  ...
  /// 设置定位参数
  Future<void> setLocationOption(AMapLocationOption locationOption) {
    final Map option = locationOption.getOptionsMap();
    option['pluginKey'] = _pluginKey;
    return _methodChannel.invokeMethod('setLocationOption', option);
  }
